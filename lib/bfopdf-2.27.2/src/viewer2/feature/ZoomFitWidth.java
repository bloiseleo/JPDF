// $Id: ZoomFitWidth.java 39833 2021-04-23 14:43:25Z mike $
...
public class ZoomFitWidth extends ToggleViewerWidget implements DocumentPanelListener
{
    public ZoomFitWidth() {
        super("FitWidth", "Zoom");
        setButton("Navigation", "PDFViewer.Feature.ZoomFitWidth.icon", "PDFViewer.tt.ZoomFitWidth");
        setMenu("+View\tZoom\tZoomFitWidth");
    }
